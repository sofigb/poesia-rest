...
public class HoroscopoMapperImpl implements HoroscopoMapper {
    ...
    @Override
    public HoroscopoResponseDTOconCoctel horoscopoToHoroscopoResponseDTOCoctel(Horoscopo horoscopo) {
        if ( horoscopo == null ) {
            return null;
        }

        HoroscopoResponseDTOconCoctel horoscopoResponseDTOconCoctel = new HoroscopoResponseDTOconCoctel();

        horoscopoResponseDTOconCoctel.setTipo( horoscopo.getTipo() );
        horoscopoResponseDTOconCoctel.setDescripcion( horoscopo.getDescripcion() );
        horoscopoResponseDTOconCoctel.setNombreCoctel( horoscopo.getNombreCoctel() );

        return horoscopoResponseDTOconCoctel;
    }
}
